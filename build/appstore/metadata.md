...
```
• Closing the popup with Esc or the shortcut now returns you to the app you were using.
• Copy Only also returns you to that app, ready to paste with ⌘V.
• Clicking another window keeps focus where you clicked.
```
